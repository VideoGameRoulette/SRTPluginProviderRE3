...
namespace SRTPluginProviderRE3.Structs.GameStructs
{
    ...
    public struct GameRankParameterData
    {
        ...
        [FieldOffset(0x38)] private nint difficultyParamVeryHard;
        [FieldOffset(0x40)] private nint difficultyParamImpossible;
        ...
        public IntPtr DifficultyParamVeryHard => IntPtr.Add(difficultyParamVeryHard, 0x0);
        public IntPtr DifficultyParamImpossible => IntPtr.Add(difficultyParamImpossible, 0x0);
    }
